...
if (!blank) {
  ...
  options(timeout = 60000) # устанавливаем тайм-аут побольше
...
file.copy("dics/plankton_blank.sqlite", "plankton_2018.sqlite", overwrite = T)
file.copy("dics/plankton_blank.sqlite", "plankton_2019.sqlite", overwrite = T)
file.copy("dics/plankton_blank.sqlite", "plankton_2020.sqlite", overwrite = T)
file.copy("dics/plankton_blank.sqlite", "plankton_2021.sqlite", overwrite = T)
